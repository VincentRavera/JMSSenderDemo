package fr.treeptik.wildf.jmssender;
...
public class WildFlyJmsQueueSender {
	...
	public final static String JMS_QUEUE_JNDI = "jms/DistantQueue";
	public final static String JMS_USERNAME = "admin"; // The role for this
															// user is "guest"
															// in
															// ApplicationRealm
	public final static String JMS_PASSWORD = "admin";
	public final static String WILDFLY_REMOTING_URL = "http-remoting://192.168.2.113:8080";
	...
	public void init(Context ctx, String queueName) throws NamingException, JMSException {
		...
		// null]
		qcon = qconFactory.createQueueConnection(WildFlyJmsQueueSender.JMS_USERNAME,
				WildFlyJmsQueueSender.JMS_PASSWORD);
